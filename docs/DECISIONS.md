...
- **Decision**: 
  ...
  6. Formally record that the sub-millimeter median forward surface residual ($0.1633\text{ mm}$) and translation magnitude of $0.2472\text{ mm}$ (approximately one voxel spacing and below the $0.25\text{-mm}$ through-plane spacing) provide decisive geometric evidence consistent with $G_0$ being derived directly from this micro-CT volume, distinguishing geometric correspondence from archival provenance proof.
