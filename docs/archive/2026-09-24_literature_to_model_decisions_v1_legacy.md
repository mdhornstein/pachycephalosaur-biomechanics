# [SUPERSEDED ARCHIVE] Literature-to-Model Decisions Specification (v1 Agent Draft)

> [!WARNING]
> **Archival Notice**:
> This document is a **historical archive** (commit `75dcfa9`). It has been formally superseded by the independent canonical bridge specification in [`docs/LITERATURE_TO_MODEL_DECISIONS.md`](../LITERATURE_TO_MODEL_DECISIONS.md) per Decision [`D008`](../DECISIONS.md). Do not cite or use for active simulation design.
