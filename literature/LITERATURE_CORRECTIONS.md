...
| **AF-15** | Omission of Nirody et al. (2022) quantitative high-resolution CT vascularity study of *Stegoceras validum*. | Missing Literature | Added Nirody et al. (2022) as core reference (`BIO-13` / `P24` / `UALVP2-22`). Integrated findings on internal vascular canal density, spatial variation, and ontogenetic remodeling into dome anatomy, CT interpretation, and material zonation sections. | Nirody, J. A., et al. (2022). *JVP* 41(5):e2036991. DOI: `10.1080/02724634.2021.2036991`. | `corrected` |
...
1. **Three-Tier Material Decision Logic**:
   ...
   - *Tier 2: Constitutive Parameter Assignment*: Because fossil bone is permineralized, original living mechanical properties ($E, \nu$) cannot be measured directly. Properties assigned in literature (e.g., cancellous $E = 1.0\text{ GPa}$, cortical $E = 17.0\text{ GPa}$) are **model assumptions**, not experimental measurements.
...
2. **Role of the Homogeneous Baseline**:
   - The Phase 4 homogeneous isotropic model ($E = 17.0\text{ GPa}, \nu = 0.30$) is defined as a **simplified control baseline**. It serves to isolate geometry and boundary effects before introducing heterogeneous material zonation in Phase 8.
...
2. **Load-Case Scenario Families**:
   - Incorporating the insights of Woodruff & Ackermans (2026), cranial combat among extant vertebrates exhibits wide variation in contact area, angle of incidence, and striking location. The project rejects collapsing impact into a single canonical “headbutt,” instead mandating a structured family of discrete load cases (varying dorsal patch area $A \in [2500, 4000]\text{ mm}^2$, impact inclination $\alpha \in [0^\circ, 20^\circ]$, and contact position).
...
1. **Nirody et al. (2022)** (*Journal of Vertebrate Paleontology* 41(5):e2036991):
   ...
   - Demonstrated that vascular density varies across the dome and decreases in mature individuals, confirming histological observations by Goodwin & Horner (2004).
